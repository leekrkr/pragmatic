...
/**
  *Validates the configurationobject.
  *
...
/**
  ...
  * @private
  * /
MagicGrid.prototype.initStyles = function
initStyles()
{
if (!this.ready()) {
return;}
...
* @ private
* /
MagicGrid.prototype.items = function
items()
{
...
* @ private
* /
MagicGrid.prototype.colWidth = function
colWidth()
{
...
* @ private
* /
MagicGrid.prototype.setup = function
setup()
{
    var
...
var
wSpace = width - numCols * colWidth + this.gutter;
...
* @ private
* /
MagicGrid.prototype.nextCol = function
nextCol(cols, i)
{
if (this.useMin)
{
...
grid.
* /
MagicGrid.prototype.positionItems = function
positionItems()
{
var
ref = this.setup();
...
var
left = col.index * colWidth + wSpace + "px";
var
top = col.height + topGutter + "px";
...
item is present
* /
MagicGrid.prototype.ready = function
ready()
{
if (this.static)
{
...
* @ private
* /
MagicGrid.prototype.getReady = function
getReady()
{
var
this$1 = this;
...
{
    this$1.
container = document.querySelector(this$1.
containerClass);
...
changes.
* /
MagicGrid.prototype.listen = function
listen()
{
var
this$1 = this;
